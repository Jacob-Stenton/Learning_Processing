...
class Slider {
  ...
  void update() {
    ...
    if (this.isX) {
      ...
      textAlign(CENTER);
      fill(255, 0, 0);
      text(str(this.data), this.X + this.size/2,this.Y - 22);
      text(this.name, this.X + this.size/2, this.Y + 15);
      ...
      textAlign(CENTER);
      fill(255, 0, 0);
      text(str(this.data), this.X + 10, height - this.Y + 20);
      pushMatrix();
      translate(this.X+6, this.Y-this.size/2);
      rotate(radians(90));
      text(this.name, 0, 0);
      popMatrix();
    }
